...
class Skynet():
    ...
    def __init__(self, fold_path: str = "/content/drive/MyDrive/tenderhack/"):

        self.fold_path = fold_path
        self.model_xgb = xgb.Booster()
        self.model_xgb.load_model(fold_path + "xgb_regressor.json")
    ...
    def recommend(self, last_ids: List[int], topn=15):
...
# USAGE EXAMPLE
predictor = Skynet(fold_path='xgb_files/')
recommended = predictor.recommend([1257331, 1205312, 1228720])
